<?php
$my_email = "registration@htffconference.com";
$errors = array();
...
Thank you for registering for HTFF 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@htffconference.com. You can find the copyright form here: www.htffconference.com/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@htffconference.com mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for HTFF'16";

$your_headers = "From: HTFF'16 <" . $my_email . ">";
...
<title>HTFF'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>3<sup>rd</sup> International Conference on Heat<br>Transfer and Fluid Flow (HTFF'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">HTFF 2016:</p>
      <p class="body">HTFF 2016 will  be held in Ottawa, Canada on August 22 - 23, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
  ...
  <div class="unit-spacer content">
    ...
    <p class="body">If you do not receive an email, <strong>please check your SPAM folder</strong>.</p>
 	...
 	<p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
  	...
  	<p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@htffconference.com" class="body-link">registration@htffconference.com</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

	<p class="body">We are looking forward to seeing you at HTFF'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding HTFF'16, please fill out the form below:</p>
